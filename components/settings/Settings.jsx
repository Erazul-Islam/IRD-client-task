        ...
        <div className='bg-white ml-8 mt-24 shadow-lg rounded-2xl w-[300px]'>
            ...
            <div className='bg-[#F7F8FA] w-[270px] ml-4 mt-4 h-[50px]'>
                ...
                <div className='flex'>
                    ...
                    <div className='bg-[#E8F0F5] mt-2 w-9 h-9 rounded-full  ml-6 '>
                        <img className='mt-2 ml-[5px]' src="https://i.ibb.co.com/Hg2H9FD/general.png" alt="" />
                    </div>
                    <div>
                ...
                <div className='flex'>
                    ...
                    <div className='bg-[#E8F0F5] mt-2 w-9 h-9 rounded-full  ml-6 '>
                        <img className='mt-2 ml-[5px]' src="https://i.ibb.co.com/GQbmBXQ/ruqyah.png" alt="" />
                    </div>
                    <div>
                ...
                <div className='flex'>
                    ...
                    <div className='bg-[#E8F0F5] mt-2 w-9 h-9 rounded-full  ml-6 '>
                        <img className='mt-2 ml-[5px]' src="https://i.ibb.co.com/8KKCzsD/books.png" alt="" />
                    </div>
                    <div>
